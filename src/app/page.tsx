...
export default function Home() {
  ...
  return (
    <div className="w-screen text-center py-10 min-h-screen bg-gradient-to-b from-slate-950  to-slate-900">
      <div className="h-full flex flex-col gap-10 mx-auto py-10 text-slate-400 w-11/12">
        ...
        <div className="mt-10 w-11/12 sm:w-4/5 md:w-2/3 mx-auto py-10">
          ...
          <div className="h-fit flex flex-col mt-6 gap-10 md:flex-row px-4">
            <div className="flex flex-col gap-2 border-2 border-slate-700 bg-gradient-to-b from-slate-950  to-slate-900 rounded-md py-4 px-3">
            ...
            <div  className="flex flex-col border-2 gap-2 border-slate-700 bg-gradient-to-b from-slate-950  to-slate-900 rounded-md py-4 px-3">
